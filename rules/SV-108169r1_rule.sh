#!/bin/bash 
 ...
 # V-99065 - SV-108169r1_rule - The Oracle Linux operating system must prevent a user from overriding the session idle-delay setting for the graphical user interface. 
...
if [ -n "$desk_top" ]; then
 ...
 echo "V-99065 - SV-108169r1_rule - $result - $finding"  

#!/bin/bash 
 ...
 # V-99263 - SV-108367r1_rule - The Oracle Linux operating system must not allow removable media to be used as the boot loader unless approved. 
...
if [[ "$grub_path" == "/boot/grub2/grub.cfg" || "$grub_path" ==  "/boot/efi/EFI/redhat/grub.cfg" ]]; then
 ...
 echo "V-99263 - SV-108367r1_rule - $result - $finding"  

#!/bin/bash 
 ...
 # V-99199 - SV-108303r1_rule - The Oracle Linux operating system must be configured so that all local interactive user home directories are owned by their respective users. 
...
do
 ...
 echo "V-99199 - SV-108303r1_rule - $result - $finding"  

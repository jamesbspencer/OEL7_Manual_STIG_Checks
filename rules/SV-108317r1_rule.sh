#!/bin/bash 
 ...
 # V-99213 - SV-108317r1_rule - The Oracle Linux operating system must be configured so that all local initialization files have mode 0740 or less permissive. 
...
do
 ...
 echo "V-99213 - SV-108317r1_rule - $result - $finding"  

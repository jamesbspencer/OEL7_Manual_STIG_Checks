#!/bin/bash 
 ...
 # V-99287 - SV-108391r1_rule - The Oracle Linux operating system must initiate an action to notify the System Administrator (SA) and Information System Security Officer (ISSO), at a minimum, when allocated audit record storage volume reaches 75 percent of the repository maximum audit record storage capacity. 
...
if [[ "$part_path" =~ "audit" ]]; then
 ...
 echo "V-99287 - SV-108391r1_rule - $result - $finding"  

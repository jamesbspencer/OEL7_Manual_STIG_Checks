#!/bin/bash 
 ...
 # V-99523 - SV-108627r1_rule - The Oracle Linux operating system access control program must be configured to grant or deny system access to specific hosts and services. 
...
if [ "$enabled" = "enabled" ] && [ "$active" = "active" ]; then
 ...
 echo "V-99523 - SV-108627r1_rule - $result - $finding"  

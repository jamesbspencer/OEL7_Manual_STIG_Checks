#!/bin/bash 
 ...
 # V-99205 - SV-108309r1_rule - The Oracle Linux operating system must be configured so that all files and directories contained in local interactive user home directories are group-owned by a group of which the home directory owner is a member. 
...
do
 ...
 echo "V-99205 - SV-108309r1_rule - $result - $finding"  

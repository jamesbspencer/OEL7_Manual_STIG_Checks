#!/bin/bash 
 ...
 # V-99201 - SV-108305r1_rule - The Oracle Linux operating system must be configured so that all local interactive user home directories are group-owned by the home directory owners primary group. 
...
do
 ...
 echo "V-99201 - SV-108305r1_rule - $result - $finding"  

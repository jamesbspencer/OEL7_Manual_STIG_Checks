#!/bin/bash 
 ...
 # V-99059 - SV-108163r1_rule - The Oracle Linux operating system must prevent a user from overriding the screensaver lock-enabled setting for the graphical user interface. 
...
if [ -n "$desk_top" ]; then
 ...
 echo "V-99059 - SV-108163r1_rule - $result - $finding"  

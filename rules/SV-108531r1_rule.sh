#!/bin/bash 
 ...
 # V-99427 - SV-108531r1_rule - The Oracle Linux operating system must implement cryptography to protect the integrity of Lightweight Directory Access Protocol (LDAP) communications. 
...
then
 ...
 echo "V-99427 - SV-108531r1_rule - $result - $finding"  
